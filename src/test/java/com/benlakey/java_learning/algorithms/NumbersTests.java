...
import com.benlakey.java_learning.algorithms.Numbers;
...
public class NumbersTests {
	...
	public void canFindCountOfBitsInNumbers() {
		...
		assertEquals(3, Numbers.bitCount(7));
		assertEquals(3, Numbers.bitCount(42));
		assertEquals(2, Numbers.bitCount(5));
		assertEquals(1, Numbers.bitCount(16));
